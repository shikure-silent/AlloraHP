  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-[rgba(255,247,241,0.92)] backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-6 px-6 py-4">
        ...
        <Link
          href="/contact"
          className="inline-flex items-center justify-center rounded-full bg-foreground px-5 py-2 text-sm font-medium text-background shadow-sm transition hover:bg-accent-strong"
        >
          相談する
        </Link>
      </div>
