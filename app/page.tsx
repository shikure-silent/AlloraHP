      ...
      <main>
          ...
          <div className="mx-auto w-full max-w-6xl px-6 pb-20 pt-16 lg:pb-28 lg:pt-20">
            <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr]">
              <div className="motion-safe:animate-[rise_0.8s_ease-out_both]">
                ...
                <h1 className="mt-4 text-4xl font-semibold leading-tight tracking-tight text-foreground sm:text-5xl lg:text-6xl font-display">
              ...
              <div className="rounded-3xl border border-border bg-card p-8 shadow-[0_25px_60px_rgba(31,23,19,0.08)] motion-safe:animate-[rise_0.9s_ease-out_0.1s_both]">
                ...
                <div className="mt-6 rounded-2xl border border-dashed border-border px-4 py-4 text-xs text-muted">
        ...
        <section id="services" className="mx-auto w-full max-w-6xl px-6 py-16">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold text-foreground font-display">
                目的から逆算した制作と開発
              </h2>
            </div>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {siteData.services.map((service, index) => (
              <div
                key={service.title}
                className="flex h-full flex-col gap-6 rounded-3xl border border-border bg-card p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md"
              >
        ...
        >
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div className="rounded-3xl border border-border bg-[linear-gradient(135deg,#fffdfa,#f7e9de)] p-8 shadow-[0_20px_50px_rgba(31,23,19,0.08)]">
              <div className="flex items-center justify-between">
                <p className="text-xs uppercase tracking-[0.3em] text-muted">
                  Works
                </p>
        ...
        <section id="recruit" className="mx-auto w-full max-w-6xl px-6 py-16">
          <div className="rounded-[40px] border border-border bg-surface p-10 shadow-sm">
